...
const FRAME_OPTIONS = [
    ...
    { id: 'frame-my-khe', label: "Mỹ Khê", image: '/frame-my-khe.png' },
    { id: 'frame-linh-ung', label: "Linh Ứng", image: '/frame-linh-ung.png' },
    { id: 'frame-cho-han', label: "Chợ Hàn", image: '/frame-cho-han.png' },
];
