...
export const useVideoComposer = ({
    ...
    const generateVideo = useCallback(async () => {
        ...
        try {
            ...
            // Canvas Setup
            const isCustomFrame = ['frame-danang', 'frame-foodtour', 'frame-bao-xuan', 'frame-chuyen-tau', 'frame-final-1', 'frame-cuoi-1', 'frame-cuoi-2', 'frame-cuoi-3', 'frame-quan-su', 'frame-lich-xanh-duong', 'frame-lich-hong', 'frame-lich-xanh', 'frame-lich-xam', 'frame-lich-den', 'frame-xtn', 'frame-my-khe', 'frame-linh-ung', 'frame-cho-han', 'frame-3004'].includes(selectedFrameId);
    ...
    }, [enabled, status, rawVideoClips, selectedFrameId, selectedPhotoIndices, signatureData, customMessage]); // Dependencies
